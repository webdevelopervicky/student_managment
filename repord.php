              ...
              <fieldset>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-3 col-12  mt-2 mt-lg-0">
                    ...
                    <select name="grade" class="py-1 rounded ms-2" style="border-radius:20px">
                  ...
                  <div class="form-group col-2 mt-2 mt-lg-0">
                        ...
                        ?>
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="repordshow.php?registerno=<?php echo $joinrow['register_no']; ?>">
                                  <button class="button buttonmodel" data-bs-target="#myModal" data-bs-toggle="modal" style="--clr: #00ad54;">
                                    <span class="button-decor"></span>
                                    <div class="button-content">
                                      <div class="button__icon">
                                        <i class="bi bi-file-earmark-pdf text-white"></i>
                                      </div>
                                      <span class="button__text" style="font-size:12px">Fee repord</span>
                                    </div>
                                  </button></a>
