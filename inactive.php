          ...
          <div class="row g-0 p-2">
            ...
            <div class="col-12 p-2 border">
              ...
              <div class="row g-0 pt-2">
                ...
                <div class="col-lg-3 co-12 mt-2 mt-lg-0 text-end">
                  ...
                  <table class="table tablecolor mt-5">
                    ...
                    <div class="content activepage">
                      <tbody>
                        ...
                        $selecresult =  $selectquery->selecttabel($conneection->con, "students_managment", 'inactive', "status");
                          ...
                          while ($row = $selecresult->fetch_assoc()) { ?>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="empty.php?register_active=<?php echo $row['register_no']; ?>">

                                  <button class="lock-button bg-success">

                                    <svg class="lock-svgIcon" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
                                ...
                                <a href="empty.php?deletkey=<?php echo $row['register_no'];  ?>" onclick="return confirmdelet();">
